...
pub fn declare_runtime_ext<M: ClifModule>(
    ...
    let rt_sock_to_id = module
        .declare_function(
            "datara_rt_socket_set_timeout",
            Linkage::Import,
            &sock_2_i64_ret_sig,
        )
        .map_err(|e| e.to_string())?;
    func_ids.insert(
        "datara_rt_socket_set_timeout".into(),
        (rt_sock_to_id, sock_2_i64_ret_sig.clone()),
    );
    func_ids.insert(
        "socket_set_timeout".into(),
        (rt_sock_to_id, sock_2_i64_ret_sig.clone()),
    );

    let rt_sock_nb_id = module
        .declare_function(
            "datara_rt_socket_nonblocking",
            Linkage::Import,
            &sock_2_i64_ret_sig,
        )
        .map_err(|e| e.to_string())?;
    func_ids.insert(
        "datara_rt_socket_nonblocking".into(),
        (rt_sock_nb_id, sock_2_i64_ret_sig.clone()),
    );
    func_ids.insert(
        "socket_nonblocking".into(),
        (rt_sock_nb_id, sock_2_i64_ret_sig.clone()),
    );
    ...
    let rt_sock_ro_id = module
        ...
        .map_err(|e| e.to_string())?;
    func_ids.insert(
        "datara_rt_socket_recv_outcome".into(),
        (rt_sock_ro_id, sock_2_i64_ret_sig.clone()),
    );
    func_ids.insert(
        "socket_recv_outcome".into(),
        (rt_sock_ro_id, sock_2_i64_ret_sig),
    );
    ...
    let rt_f2sp_id = module
        .declare_function("datara_rt_float_to_str_prec", Linkage::Import, &rt_f2sp_sig)
        .map_err(|e| e.to_string())?;
    func_ids.insert(
    ...
    let rt_i2sr_id = module
        .declare_function("datara_rt_int_to_str_radix", Linkage::Import, &rt_i2sr_sig)
        .map_err(|e| e.to_string())?;
    func_ids.insert(
        "datara_rt_int_to_str_radix".into(),
        (rt_i2sr_id, rt_i2sr_sig.clone()),
    );
    func_ids.insert("int_to_str_radix".into(), (rt_i2sr_id, rt_i2sr_sig.clone()));
    ...
    let rt_d2sp_id = module
        .declare_function("datara_rt_dec64_to_str_prec", Linkage::Import, &rt_d2sp_sig)
        .map_err(|e| e.to_string())?;
    func_ids.insert(
        "datara_rt_dec64_to_str_prec".into(),
        (rt_d2sp_id, rt_d2sp_sig.clone()),
    );
    func_ids.insert("dec64_to_str_prec".into(), (rt_d2sp_id, rt_d2sp_sig));
