...
pub struct RuntimeIds {
    ...
    pub rt_list_pop_outcome_id: FuncId,
    // v1.4.1: full List<T> protocol.
    pub rt_list_sort_id: FuncId,
    pub rt_list_remove_at_id: FuncId,
    pub rt_list_remove_value_id: FuncId,
    pub rt_list_insert_at_id: FuncId,
    pub rt_list_contains_id: FuncId,
    pub rt_list_index_of_id: FuncId,
    pub rt_list_reverse_id: FuncId,
    pub rt_list_clear_id: FuncId,
    pub rt_list_slice_id: FuncId,
    pub rt_list_first_id: FuncId,
    pub rt_list_last_id: FuncId,
    pub rt_list_is_empty_id: FuncId,
    pub rt_exec_utf8_id: FuncId,
    pub rt_str_cmp_id: FuncId,
    pub rt_env_set_id: FuncId,
...
pub struct CoreRuntimeIds {
    ...
    pub rt_map_insert_id: FuncId,
    pub rt_list_pop_outcome_id: FuncId,
    // v1.4.1: full List<T> protocol + UTF-8 exec.
    pub rt_list_sort_id: FuncId,
    pub rt_list_remove_at_id: FuncId,
    pub rt_list_remove_value_id: FuncId,
    pub rt_list_insert_at_id: FuncId,
