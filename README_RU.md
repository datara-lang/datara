...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/версия-1.2.4-blue.svg" alt="Версия" />
...
```bash
code --install-extension editors/vscode/datara-1.2.4.vsix
```
...
```bash
# Debian / Ubuntu / Mint:
sudo dpkg -i dist/datara_1.2.4_amd64.deb

# Fedora / RHEL / CentOS:
sudo rpm -i dist/datara-1.2.4.x86_64.rpm
```
