...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/версия-1.2.3-blue.svg" alt="Версия" />
...
```bash
code --install-extension editors/vscode/datara-1.2.3.vsix
```
...
```bash
# Debian / Ubuntu / Mint:
sudo dpkg -i dist/datara_1.2.3_amd64.deb

# Fedora / RHEL / CentOS:
sudo rpm -i dist/datara-1.2.3.x86_64.rpm
```
